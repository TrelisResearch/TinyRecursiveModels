...
\begin{figure}[t]
    \centering
    \fbox{\parbox{0.95\columnwidth}{Placeholder for pass@2 and pass@1000 plot.}}
    \caption{Planned figure: ARC evaluation pass@2 and pass@1000 accuracies for the extended pre-training runs.}
    \label{fig:extended_pass_accuracy}
\end{figure}

\begin{figure}[t]
    \centering
    \fbox{\parbox{0.95\columnwidth}{Placeholder for evaluation and train exact accuracy plot.}}
    \caption{Planned figure: evaluation and train exact accuracies throughout extended pre-training.}
    \label{fig:extended_exact_accuracy}
\end{figure}

\begin{figure}[t]
    \centering
    \fbox{\parbox{0.95\columnwidth}{Placeholder for embedding cosine within-task plot.}}
    \caption{Planned figure: train and evaluation embedding cosine similarity within task variants.}
    \label{fig:embedding_cosine_within}
\end{figure}

\begin{figure}[t]
    \centering
    \fbox{\parbox{0.95\columnwidth}{Placeholder for embedding cosine across tasks plot.}}
    \caption{Planned figure: train and evaluation embedding cosine similarity across base tasks.}
